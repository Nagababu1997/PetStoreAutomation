...
public class ExcelUtility {
	...
	public void fileGreenColor(String sheetName, int rownum, int columnum) throws Exception {
		fi = new FileInputStream(path);
		workbook = new XSSFWorkbook(fi);
		sheet = workbook.getSheet(sheetName);
	...
	public void fillRedColor(String sheetName, int rownum, int colmnum) throws Exception {
		fi = new FileInputStream(path);
		workbook = new XSSFWorkbook(fi);
		sheet = workbook.getSheet(sheetName);
